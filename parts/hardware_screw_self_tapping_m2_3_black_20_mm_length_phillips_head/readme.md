# Hardware Screw Self Tapping M2 3 Black 20 mm Length Phillips Head  
...
### id
* oomp_id: hardware_screw_self_tapping_m2_3_black_20_mm_length_phillips_head
...
* oomp_word: three tram strawberry
* oomp_word_emoji :three: :tram: :strawberry:
* md5_6_alpha: 9k0jx
* md5_6: f4e8cd
...
| directory | parts/hardware_screw_self_tapping_m2_3_black_20_mm_length_phillips_head |  
| distributors | [] |  
| filter |  |  
| from_yaml | False |  
| github_link | https://github.com/oomlout/oomlout_oomp_part_src/tree/main/parts/hardware_screw_self_tapping_m2_3_black_20_mm_length_phillips_head |  
| id | hardware_screw_self_tapping_m2_3_black_20_mm_length_phillips_head |  
| id_no_class | screw_self_tapping_m2_3_black_20_mm_length_phillips_head |  
| id_no_color | 20_mm_length_phillips_head |  
| id_no_size | black_20_mm_length_phillips_head |  
| id_no_type | m2_3_black_20_mm_length_phillips_head |  
| kicad_reference |  |  
| manufacturer |  |  
...
| md5_10 | f4e8cdcc1c |  
| md5_10_upper | F4E8CDCC1C |  
| md5_5 | f4e8c |  
| md5_5_upper | F4E8C |  
| md5_6 | f4e8cd |  
| md5_6_alpha | 9k0jx |  
| md5_6_alpha_upper | 9K0JX |  
| md5_6_upper | F4E8CD |  
| name | Hardware Screw Self Tapping M2 3 Black 20 mm Length Phillips Head |  
| name_no_class | Screw Self Tapping M2 3 Black 20 mm Length Phillips Head |  
...
| name_no_type | M2 3 Black 20 mm Length Phillips Head |  
| oomlout_bolt_color | Black |  
| oomlout_bolt_head_type | Phillips |  
| oomlout_bolt_head_type_diagram | head_type_diagram.png |  
| oomlout_bolt_length | 20 mm |  
| oomlout_bolt_length_no_unit | 20 |  
| oomlout_bolt_md5_6_alpha_first_3 | 9k0 |  
| oomlout_bolt_md5_6_alpha_first_3_upper | 9K0 |  
| oomlout_bolt_md5_6_alpha_last_3 | jx |  
| oomlout_bolt_md5_6_alpha_last_3_upper | JX |  
| oomlout_bolt_md5_6_first_3 | f4e |  
| oomlout_bolt_md5_6_first_3_upper | F4E |  
| oomlout_bolt_md5_6_last_3 | 8cd |  
| oomlout_bolt_md5_6_last_3_upper | 8CD |  
| oomlout_bolt_name | Self Tapping M2_3X20 mm Black (Phillips) |  
| oomlout_bolt_size |  |  
| oomlout_bolt_size_long | M2.3 |  
| oomlout_bolt_type | Self Tapping |  
| oomlout_bolt_type_diagram_diagram | type_diagram.png |  
| oomlout_short_code | st2d3b20p |  
| oomlout_short_code_upper | ST2D3B20P |  
| oomp_key | oomp_hardware_screw_self_tapping_m2_3_black_20_mm_length_phillips_head |  
| oomp_word | three tram strawberry |  
| oomp_word_emoji | :three: :tram: :strawberry: |  
| oomp_word_emoji_list | [':three:', ':tram:', ':strawberry:'] |  
| oomp_word_list | ['three', 'tram', 'strawberry'] |  
| part_number |  |  
| part_number_capital |  |  
