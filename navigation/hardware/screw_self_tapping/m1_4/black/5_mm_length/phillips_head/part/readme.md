# Hardware Screw Self Tapping M1 4 Black 5 mm Length Phillips Head  
...
### id
* oomp_id: hardware_screw_self_tapping_m1_4_black_5_mm_length_phillips_head
...
### other_codes
* short_code: st1d4b5p
* oomp_word: coffee diamonds hamster
* oomp_word_emoji :coffee: :diamonds: :hamster:
* md5_6_alpha: 71po5
* md5_6: b49f35
...
| directory | parts/hardware_screw_self_tapping_m1_4_black_5_mm_length_phillips_head |  
| distributors | [] |  
| filter |  |  
| from_yaml | False |  
| github_link | https://github.com/oomlout/oomlout_oomp_part_src/tree/main/parts/hardware_screw_self_tapping_m1_4_black_5_mm_length_phillips_head |  
| id | hardware_screw_self_tapping_m1_4_black_5_mm_length_phillips_head |  
| id_no_class | screw_self_tapping_m1_4_black_5_mm_length_phillips_head |  
| id_no_color | 5_mm_length_phillips_head |  
| id_no_size | black_5_mm_length_phillips_head |  
| id_no_type | m1_4_black_5_mm_length_phillips_head |  
| kicad_reference |  |  
| manufacturer |  |  
...
| md5_10 | b49f35d0a3 |  
| md5_10_upper | B49F35D0A3 |  
| md5_5 | b49f3 |  
| md5_5_upper | B49F3 |  
| md5_6 | b49f35 |  
| md5_6_alpha | 71po5 |  
| md5_6_alpha_upper | 71PO5 |  
| md5_6_upper | B49F35 |  
| name | Hardware Screw Self Tapping M1 4 Black 5 mm Length Phillips Head |  
| name_no_class | Screw Self Tapping M1 4 Black 5 mm Length Phillips Head |  
...
| name_no_type | M1 4 Black 5 mm Length Phillips Head |  
| oomlout_bolt_color | Black |  
| oomlout_bolt_head_type | Phillips |  
| oomlout_bolt_head_type_diagram | head_type_diagram.png |  
| oomlout_bolt_length | 5 mm |  
| oomlout_bolt_length_no_unit | 5 |  
| oomlout_bolt_md5_6_alpha_first_3 | 71p |  
| oomlout_bolt_md5_6_alpha_first_3_upper | 71P |  
| oomlout_bolt_md5_6_alpha_last_3 | o5 |  
| oomlout_bolt_md5_6_alpha_last_3_upper | O5 |  
| oomlout_bolt_md5_6_first_3 | b49 |  
| oomlout_bolt_md5_6_first_3_upper | B49 |  
| oomlout_bolt_md5_6_last_3 | f35 |  
| oomlout_bolt_md5_6_last_3_upper | F35 |  
| oomlout_bolt_name | Self Tapping M1_4X5 mm Black (Phillips) |  
| oomlout_bolt_size |  |  
| oomlout_bolt_size_long | M1.4 |  
| oomlout_bolt_type | Self Tapping |  
| oomlout_bolt_type_diagram_diagram | type_diagram.png |  
| oomlout_short_code | st1d4b5p |  
| oomlout_short_code_upper | ST1D4B5P |  
| oomp_key | oomp_hardware_screw_self_tapping_m1_4_black_5_mm_length_phillips_head |  
| oomp_word | coffee diamonds hamster |  
| oomp_word_emoji | :coffee: :diamonds: :hamster: |  
| oomp_word_emoji_list | [':coffee:', ':diamonds:', ':hamster:'] |  
| oomp_word_list | ['coffee', 'diamonds', 'hamster'] |  
| part_number |  |  
| part_number_capital |  |  
